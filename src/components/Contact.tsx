        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            >
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-theme-accent to-theme-accent-secondary hover:from-theme-accent-secondary hover:to-theme-accent text-black py-3 rounded-lg flex items-center justify-center gap-2 transition-all hover:shadow-[0_0_20px_rgba(8,145,178,0.5)]"
              >
