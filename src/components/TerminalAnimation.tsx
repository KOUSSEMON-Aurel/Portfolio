...
export function TerminalAnimation() {
  ...
  return (
    <motion.div
      ...
      className="bg-theme-nav border border-theme-accent/50 rounded-lg p-2 md:p-4 font-mono text-xs md:text-sm max-h-48 sm:max-h-64 md:max-h-96 overflow-y-auto backdrop-blur-sm"
    >
